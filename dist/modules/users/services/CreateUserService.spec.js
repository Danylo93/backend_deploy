...
describe('CreateUsers', function () {
    beforeEach(function () {
        ...
        createUsers = new CreateUserService_1.default(fakeUsersRepository, fakeHashProvider, fakeCacheProvider);
    });
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createUsers.execute({
                        name: 'Danylo',
                ...
                case 1:
                    users = _a.sent();
                    return [4 /*yield*/, expect(users).toHaveProperty('id')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to create a new user with same email from another', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createUsers.execute({
                            name: 'John Doe',
                            email: 'john@example.com',
                            password: '12345',
