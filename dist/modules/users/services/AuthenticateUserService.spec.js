...
var authenticateUsers;
describe('AuthenticateUser', function () {
    beforeEach(function () {
        fakeUsersRepository = new FakeUsersRepository_1.default();
        fakeHashProvider = new FakeHashProvider_1.default();
        authenticateUsers = new AuthenticateUserService_1.default(fakeUsersRepository, fakeHashProvider);
    });
    it('should be able to authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, authenticateUsers.execute({
                            email: 'john@example.com',
                            password: '123456',
                        })];
                case 2:
    ...
    it('should not be able to authenticate with non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(authenticateUsers.execute({
                        email: 'john@example.com',
                        password: '123456',
    ...
    it('should not be able to authenticate with wrong password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(authenticateUsers.execute({
                            email: 'john@example.com',
